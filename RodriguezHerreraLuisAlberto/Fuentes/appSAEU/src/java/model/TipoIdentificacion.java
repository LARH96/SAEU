...
public class TipoIdentificacion {
    ...
    public TipoIdentificacion(int id, String descripcion, boolean log_estado, int codUsuario_Registra, Date fechaRegistra, int codUsuario_Edita, Date fechaEdita) {
        this.id = id;
        this.descripcion = descripcion;
